...
@Service
public class MinioClientService implements InitializingBean {
    ...
    public void removeObject(String bucketName, String objectName) {
        ...
        if (flag) {
            try {
                ...
                throw new RuntimeException("oss文件删除失败" + bucketName + objectName);
            }
        } else {
            throw new RuntimeException("oss的bucketName不存在");
        }
    }
