package top.hugo.system.listener;
...
import top.hugo.common.excel.ExcelListener;
import top.hugo.common.excel.ExcelResult;
import top.hugo.common.excel.ValidatorUtils;
...
public class SysUserImportListener extends AnalysisEventListener<SysUserImportVo> implements ExcelListener<SysUserImportVo> {
    ...
    public SysUserImportListener(Boolean isUpdateSupport) {
        ...
        this.operName = LoginHelper.getUserInfo().getUsername();
    }
